...
# Note: Phase-specific toggles (mention-market-phase3/4) were removed in Dec 2024.
...
TRADING_IDEAS = [
    ...
    {'idea_id': 'hoops', 'display_name': 'Hoops', 'description': 'Basketball in-game trading (NCAA/NBA)'},
]
