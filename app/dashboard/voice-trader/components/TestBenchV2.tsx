 ...
 * It can be modified to test v2-specific features while TestBenchLegacy remains stable.
 * 
 * v2 Pipeline Features:
 * - Plugin-based audio sources
 * - Plugin-based STT providers
 * - Ring buffer for async/thread bridging
